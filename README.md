...
9. The code doesnt have a frontend, please feel free to use curl instead for example: curl -X POST "https://0b28k0jrog.execute-api.us-east-1.amazonaws.com/chat" -H "Content-Type: application/json" -d "{\"prompt\":\"Hello?\"}"
In the above, feel free to replace 0b28k0jrog with your api gateway link.
